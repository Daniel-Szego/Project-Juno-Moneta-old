...
module.exports = async function (deployer) {
  ...
  await deployer.deploy(DCBM,Name,Symbol, {from: accounts[7]});
  ...
  await DCBMInstance.whitelistAccount(CommercialBankAccount, {from: accounts[7]})
  ...
  await DCBMInstance.mint(CommercialBankAccount, 100, {from: accounts[7]})
  ...
  await DCBMInstance.transfer(CrossBorderBankAccount, 50, {from: accounts[8]});
